...
const AirtimePurchase = () => {
    ...
    const handlePurchase = async () => {
        try {
            if (provider && phoneNumber && amount) {
                ...
                await axios.post('http://localhost:3000/api/transactions', transactionDetails);
                // Open TON Wallet
                // if (window.ton) {
    ...
    const config = {
        public_key: 'FLWPUBK_TEST-7fe13363dc06b0b31d8db6a85c41c07f-X', // Replace with your Flutterwave public key
        tx_ref: Date.now(),

      ...
      <div className="bg-gray-800 min-h-screen flex flex-col text-white">
        ...
        <section className="container mx-auto px-4 py-6 flex-grow">
          <div className="flex justify-between items-center mb-10">
            ...
            {address ? (
              <>
                <h1 className="text-2xl font-semibold text-gray-500">{balance !== null ? `${balance} TON` : 'Fetching balance...'}</h1>
              </>
            ) : (
              <h1 className='text-2xl font-semibold text-gray-500'>Connecting to wallet...</h1>
            )}
          </div>

          {/* Menu Control */}
          <ul className="grid grid-cols-3 sm:grid-cols-6 gap-4 mb-12">
            ...
            <li key="TV Subscription" className="flex flex-col items-center">
              <a href="/tv-subscribe" className="text-center text-gray-500 hover:text-gray-700 transition">
                <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full shadow-md mb-2">
                  <img src="/tv.svg" alt="" />
                </div>
                <span className="text-xs sm:text-base">TV</span>
              </a>
            </li>
